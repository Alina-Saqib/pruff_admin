...
function RecurringSms({recurringSms,handleDelete }: any) {
...
const handleChangePage = (event: any, newPage: any) => {
 ...
 <TableContainer sx={{mt:2, mb:3}} component={Paper}>
   <Table>
     ...
     <TableBody>
       {recurringSms.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((SMS: any) => (
     ...
     <TableCell>{SMS.frequency === null ? "Not a Recurring SMS": SMS.frequency}</TableCell>
